...
class Prompt:
    ...
    def append_points(self, points, labels, mask=None):
        """Append point prompts to the existing geometric prompt.

        Args:
            points: Point coordinates of shape (N_points, B, 2), normalized in [0, 1].
            labels: Point labels of shape (N_points, B). 1 for positive, 0 for negative.
            mask: Optional attention mask of shape (B, N_points).
        """
